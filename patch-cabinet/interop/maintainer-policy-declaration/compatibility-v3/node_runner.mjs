...
const root = path.join(project, "interop", "maintainer-policy-declaration", "compatibility-v3");
...
const required = {"ajv":"8.20.0","fast-deep-equal":"3.1.3","fast-uri":"3.1.7","json-schema-traverse":"1.0.0","require-from-string":"2.0.2"};
const inventory = {};
