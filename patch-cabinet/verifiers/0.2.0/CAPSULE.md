# Patch Cabinet verifier capsule 0.2.0

This capsule is the active schema-1 environment for Patch Cabinet engine 0.2.0 with policy
`season-1.2` and `packaging==26.3`.
